...
class PsortGuiWidget(QMainWindow):
    ...
    def build_mainwin_filterPanel(self):
        ...
        self.txtedit_mainwin__filterPanel_csFilter_min = QDoubleSpinBox()
        self.txtedit_mainwin__filterPanel_csFilter_min.setKeyboardTracking(True)
        self.txtedit_mainwin__filterPanel_csFilter_min.setMinimum(1.0)
        self.txtedit_mainwin__filterPanel_csFilter_min.setMaximum(15000.0)
        self.txtedit_mainwin__filterPanel_csFilter_min.setDecimals(0)
        self.setFont(self.txtedit_mainwin__filterPanel_csFilter_min, color="red")
        self.txtedit_mainwin__filterPanel_csFilter_min.setValue(10.0)
        self.txtedit_mainwin__filterPanel_csFilter_max = QDoubleSpinBox()
        self.txtedit_mainwin__filterPanel_csFilter_max.setKeyboardTracking(True)
        self.txtedit_mainwin__filterPanel_csFilter_max.setMinimum(1.0)
        self.txtedit_mainwin__filterPanel_csFilter_max.setMaximum(15000.0)
        self.txtedit_mainwin__filterPanel_csFilter_max.setDecimals(0)
        self.setFont(self.txtedit_mainwin__filterPanel_csFilter_max, color="red")
        self.txtedit_mainwin__filterPanel_csFilter_max.setValue(150.0)
        ...
        self.txtedit_mainwin__filterPanel_ssFilter_min = QDoubleSpinBox()
        self.txtedit_mainwin__filterPanel_ssFilter_min.setKeyboardTracking(True)
        self.txtedit_mainwin__filterPanel_ssFilter_min.setMinimum(1.0)
        self.txtedit_mainwin__filterPanel_ssFilter_min.setMaximum(15000.0)
        self.txtedit_mainwin__filterPanel_ssFilter_min.setDecimals(0)
        self.setFont(self.txtedit_mainwin__filterPanel_ssFilter_min, color="blue")
        self.txtedit_mainwin__filterPanel_ssFilter_min.setValue(100.0)
        self.txtedit_mainwin__filterPanel_ssFilter_max = QDoubleSpinBox()
        self.txtedit_mainwin__filterPanel_ssFilter_max.setKeyboardTracking(True)
        self.txtedit_mainwin__filterPanel_ssFilter_max.setMinimum(1.0)
        self.txtedit_mainwin__filterPanel_ssFilter_max.setMaximum(15000.0)
        self.txtedit_mainwin__filterPanel_ssFilter_max.setDecimals(0)
        self.setFont(self.txtedit_mainwin__filterPanel_ssFilter_max, color="blue")
        self.txtedit_mainwin__filterPanel_ssFilter_max.setValue(9000.0)
        # Add to layout
        ...
        self.layout_mainwin_filterPanel.\
            addWidget(self.txtedit_mainwin__filterPanel_ssFilter_min)
        self.layout_mainwin_filterPanel.\
            addWidget(self.txtlabel_mainwin_filterPanel_ssFilter_dash)
        self.layout_mainwin_filterPanel.\
            addWidget(self.txtedit_mainwin__filterPanel_ssFilter_max)
        self.layout_mainwin_filterPanel.\
            addWidget(self.txtlabel_mainwin_filterPanel_csFilter)
        self.layout_mainwin_filterPanel.\
            addWidget(self.txtedit_mainwin__filterPanel_csFilter_min)
        self.layout_mainwin_filterPanel.\
            addWidget(self.txtlabel_mainwin_filterPanel_csFilter_dash)
        self.layout_mainwin_filterPanel.\
            addWidget(self.txtedit_mainwin__filterPanel_csFilter_max)

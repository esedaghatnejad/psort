...
import numpy as np
from .. import quantities as pq
from .baseneo import BaseNeo, MergeError, merge_annotations
from .dataobject import DataObject, ArrayDict
    ...
    *Slicing*:
    ...
    def merge(self, *others):
        ...
        for other in others:
            ...
            if isinstance(other, proxyobjects.SpikeTrainProxy):

...
#%% build_rawPlot_popup_Widget
    def build_slotBoundary_Widget(self):
        ...
        # separator line
        self.line_slotBoundary_l1 = QtGui.QFrame()
        self.line_slotBoundary_l1.setFrameShape(QFrame.VLine)
        self.line_slotBoundary_l1.setFrameShadow(QFrame.Sunken)
        self.line_slotBoundary_l2 = QtGui.QFrame()
        self.line_slotBoundary_l2.setFrameShape(QFrame.VLine)
        self.line_slotBoundary_l2.setFrameShadow(QFrame.Sunken)
        self.line_slotBoundary_l3 = QtGui.QFrame()
        self.line_slotBoundary_l3.setFrameShape(QFrame.VLine)
        self.line_slotBoundary_l3.setFrameShadow(QFrame.Sunken)
        self.line_slotBoundary_l4 = QtGui.QFrame()
        self.line_slotBoundary_l4.setFrameShape(QFrame.VLine)
        self.line_slotBoundary_l4.setFrameShadow(QFrame.Sunken)
        # toolbar
        ...
        self.layout_slotBoundary_toolbar.addWidget(self.line_slotBoundary_l1)
        self.layout_slotBoundary_toolbar.addWidget(self.pushBtn_slotBoundary_addSlot)
        self.layout_slotBoundary_toolbar.addWidget(self.line_slotBoundary_l2)
        self.layout_slotBoundary_toolbar.addWidget(self.label_slotBoundary_description)
        self.layout_slotBoundary_toolbar.addWidget(self.line_slotBoundary_l3)
        self.layout_slotBoundary_toolbar.addStretch()
        self.layout_slotBoundary_toolbar.addWidget(self.line_slotBoundary_l4)

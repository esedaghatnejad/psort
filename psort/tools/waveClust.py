...
class WaveClustWidget(QWidget):
    def __init__(self, parent=None):
        ...
        self._localDataBase = {
            ...
            "is_ss": np.zeros((1), dtype=bool),
            "ss_label_selected": np.zeros((1), dtype=np.int32),
            "cs_label_selected": np.zeros((1), dtype=np.int32),
            "ss_features": np.zeros((1), dtype=bool),
            "cs_features": np.zeros((1), dtype=bool),
            "flag_gmm": np.zeros((1), dtype=bool),
    ...
    def build_scatterPlot_popup_Widget(self):
        ...
        self.pushBtn_scatterPlot_popup_setlabel.setToolTip(
        ...
        self.pushBtn_scatterPlot_popup_applymethod.setToolTip(
            "<b>A</b>pply Selected Method"
        )
        ...
        self.pushBtn_scatterPlot_popup_prev_clust.setToolTip(
            "Move to the previous cluster<br><b>(Left Arrow)"
        )
        ...
        self.pushBtn_scatterPlot_popup_next_clust.setToolTip(
            "Move to the next cluster<br><b>(Right Arrow)"
        )
        self.pushBtn_scatterPlot_popup_next_clust.setAutoRepeat(
            True
        )  # allow holding button
        ...
        self.layout_popup_scatterPlot_PcaNum.addWidget(
            self.txtlabel_popup_scatterPlot_PcaNum1
        )
        self.layout_popup_scatterPlot_PcaNum.addWidget(
        ...
        self.layout_popup_scatterPlot.addWidget(self.widget_popup_scatterPlot_PcaNum)
        self.layout_popup_scatterPlot.addWidget(self.plot_popup_scatter)
        self.layout_popup_scatterPlot.setSpacing(1)
        self.layout_popup_scatterPlot.setContentsMargins(1, 1, 1, 1)
        self.widget_popup_scatterPlot.setLayout(self.layout_popup_scatterPlot)

        # Add widgets to the layout
        self.layout_scatterPlot_popup_Btn.addWidget(
            self.pushBtn_scatterPlot_popup_cancel
        )
        ...
        # Add action widgets
        self.layout_scatterPlot_popup_mode0.addWidget(
            self.label_scatterPlot_popup_method
        )
        self.layout_scatterPlot_popup_mode0.addWidget(
            self.comboBx_scatterPlot_popup_method
        )
        ...
        self.layout_scatterPlot_popup_mode1.addWidget(
            self.label_scatterPlot_popup_spike_of_interest
        )
        self.layout_scatterPlot_popup_mode1.addWidget(
            self.comboBx_scatterPlot_popup_spike_mode
        )
        ...
        self.layout_scatterPlot_popup_mode2.addWidget(
            self.label_scatterPlot_popup_ss_label
        )
        self.layout_scatterPlot_popup_mode2.addWidget(
        ...
        self.layout_scatterPlot_popup_mode3.addWidget(
            self.label_scatterPlot_popup_cs_label
        )
        self.layout_scatterPlot_popup_mode3.addWidget(
        ...
        self.layout_scatterPlot_popup_mode4.addWidget(
        ...
        self.layout_scatterPlot_popup_mode5.addWidget(
        ...
        self.layout_scatterPlot_popup_clust.addLayout(
            self.layout_scatterPlot_popup_mode0, 0, 0
        )
        self.layout_scatterPlot_popup_clust.addLayout(
            self.layout_scatterPlot_popup_mode5, 1, 0
        )
        self.layout_scatterPlot_popup_clust.setSpacing(1)
        self.layout_scatterPlot_popup_clust.setContentsMargins(1, 1, 1, 1)

        self.layout_scatterPlot_popup_spike.addWidget(
            self.pushBtn_scatterPlot_popup_select, 0, 0
        )
        self.layout_scatterPlot_popup_spike.addWidget(
            self.pushBtn_scatterPlot_popup_delete, 0, 1
        )
        self.layout_scatterPlot_popup_spike.addWidget(
            self.pushBtn_scatterPlot_popup_setlabel, 0, 2
        )
        self.layout_scatterPlot_popup_spike.addWidget(
            self.pushBtn_scatterPlot_popup_clear, 1, 0
        )
        self.layout_scatterPlot_popup_spike.addWidget(
            self.pushBtn_scatterPlot_popup_move, 1, 1
        )
        self.layout_scatterPlot_popup_spike.addWidget(
            self.pushBtn_scatterPlot_popup_reset, 1, 2
        )
        self.layout_scatterPlot_popup_spike.setSpacing(1)
        self.layout_scatterPlot_popup_spike.setContentsMargins(1, 1, 1, 1)

        self.layout_scatterPlot_popup_label.addLayout(
            self.layout_scatterPlot_popup_mode2, 0, 0
        )
        self.layout_scatterPlot_popup_label.addLayout(
            self.layout_scatterPlot_popup_mode1, 0, 1
        )
        self.layout_scatterPlot_popup_label.addLayout(
            self.layout_scatterPlot_popup_mode3, 1, 0
        )
        self.layout_scatterPlot_popup_label.addLayout(
            self.layout_scatterPlot_popup_mode4, 1, 1
        )
        self.layout_scatterPlot_popup_label.setSpacing(1)
        self.layout_scatterPlot_popup_label.setContentsMargins(1, 1, 1, 1)

        self.layout_scatterPlot_popup_actionBtn.addLayout(
            self.layout_scatterPlot_popup_spike
        )
        self.layout_scatterPlot_popup_actionBtn.addWidget(
            self.line_scatterPlot_popup_v0
        )
        self.layout_scatterPlot_popup_actionBtn.addLayout(
            self.layout_scatterPlot_popup_clust
        )
        self.layout_scatterPlot_popup_actionBtn.addWidget(
            self.line_scatterPlot_popup_v1
        )
        self.layout_scatterPlot_popup_actionBtn.addStretch()
        self.layout_scatterPlot_popup_actionBtn.addWidget(
            self.line_scatterPlot_popup_v2
        )
        self.layout_scatterPlot_popup_actionBtn.addLayout(
            self.layout_scatterPlot_popup_label
        )
        ...
        self.layout_scatterPlot_popup_belowMainBtn_hdivider1.addWidget(
            self.plot_popup_ssxprob
        )
        self.layout_scatterPlot_popup_belowMainBtn_hdivider1.addWidget(
            self.plot_popup_csxprob
        )
        self.layout_scatterPlot_popup_belowMainBtn_vdivider.addWidget(
            self.plot_popup_waveform
        )
        self.layout_scatterPlot_popup_belowMainBtn_vdivider.addWidget(
            self.layout_scatterPlot_popup_belowMainBtn_hdivider1
        )
        self.layout_scatterPlot_popup_belowMainBtn_vdivider1.addWidget(
            self.widget_popup_scatterPlot
        )
        self.layout_scatterPlot_popup_belowMainBtn_vdivider1.addWidget(
            self.plot_popup_peakhist
        )
        self.layout_scatterPlot_popup_belowMainBtn_hdivider.addWidget(
            self.layout_scatterPlot_popup_belowMainBtn_vdivider1
        )
        self.layout_scatterPlot_popup_belowMainBtn_hdivider.addWidget(
            self.layout_scatterPlot_popup_belowMainBtn_vdivider
        )
        ...
        self.layout_scatterPlot_popup.addWidget(
            self.layout_scatterPlot_popup_belowMainBtn_hdivider
        )
    ...
    def init_scatter_plot(self):
        ...
        for counter in range(len(self.list_color)):
            self.pltData_scatter_list.append(
                self.plot_popup_scatter.plot(
                    np.zeros((0)),
                    np.zeros((0)),
                    pen=None,
                    symbol="o",
                    symbolSize=3,
                    symbolBrush=self.list_color[counter],
                    symbolPen=None,
                )
            )

        for counter in range(len(self.list_color)):
            self.pltText_scatter_list.append(
                pg.TextItem(
                    str(counter),
                    color=self.list_color[counter],
                    border="k",
            ...
            self.plot_popup_scatter.addItem(
                self.pltText_scatter_list[counter], ignoreBounds=True
            )
        ...
        self.pltData_scatter_popUpPlot_IndexSelected = self.plot_popup_scatter.plot(
            np.zeros((0)),
            np.zeros((0)),
            name="IndexSelected",
            pen=None,
        ...
        self.pltData_scatter_popUpPlot_ROI = self.plot_popup_scatter.plot(
            np.zeros((0)),
            np.zeros((0)),
            name="ROI",
        ...
        self.pltData_scatter_popUpPlot_ROI2 = self.plot_popup_scatter.plot(
            np.zeros((0)),
            np.zeros((0)),
            name="ROI2",
        ...
        self.infLine_popUpPlot_vLine = pg.InfiniteLine(
            pos=0.0, angle=90, pen=(0, 0, 0, 0), movable=False, hoverPen="g"
        )
        self.infLine_popUpPlot_hLine = pg.InfiniteLine(
            pos=0.0, angle=0, pen=(0, 0, 0, 0), movable=False, hoverPen="g"
        )

        self.plot_popup_scatter.addItem(self.infLine_popUpPlot_vLine, ignoreBounds=True)
        self.plot_popup_scatter.addItem(self.infLine_popUpPlot_hLine, ignoreBounds=True)
    ...
    def init_peakhist_plot(self):
        ...
        for counter in range(len(self.list_color)):
            self.pltData_peakhist_list.append(
                self.plot_popup_peakhist.plot(
                    np.arange((2)),
                    np.zeros((1)),
                    stepMode=True,
                    fillLevel=0,
        ...
        for counter in range(len(self.list_color)):
            # add text
            self.pltText_peakhist_list.append(
                pg.TextItem(
                    str(counter),
                    color=self.list_color[counter],
                    border="k",
            ...
            self.plot_popup_peakhist.addItem(
                self.pltText_peakhist_list[counter], ignoreBounds=True
            )
    ...
    def init_waveform_plot(self):
        self.pltData_waveform_popUpPlot = self.plot_popup_waveform.plot(
            np.zeros((0)),
            np.zeros((0)),
            name="Wave",
        ...
        self.pltData_waveform_popUpPlot_selected = self.plot_popup_waveform.plot(
            np.zeros((0)),
            np.zeros((0)),
            name="WaveSelected",
        ...
        self.pltData_waveform_popUpPlot_template = self.plot_popup_waveform.plot(
            np.zeros((0)),
            np.zeros((0)),
            name="WaveTemplate",
        ...
        self.pltData_waveform_popUpPlot_ROI = self.plot_popup_waveform.plot(
            np.zeros((0)),
            np.zeros((0)),
            name="WaveROI",
            pen=pg.mkPen(color="m", width=2, style=QtCore.Qt.SolidLine),
        ...
        self.pltData_waveform_popUpPlot_ROI2 = self.plot_popup_waveform.plot(
            np.zeros((0)),
            np.zeros((0)),
            name="WaveROI2",
            pen=pg.mkPen(color="m", width=2, style=QtCore.Qt.DotLine),
        ...
        self.infLine_waveform_minPca = pg.InfiniteLine(
            pos=-dictionaries.GLOBAL_DICT[current_WAVE_TEMPLATE_BEFORE][0] * 1000.0,
            angle=90,
            pen=(100, 100, 255, 255),
            movable=True,
            hoverPen="g",
        ...
        self.plot_popup_waveform.addItem(
            self.infLine_waveform_minPca, ignoreBounds=False
        )
        self.infLine_waveform_maxPca = pg.InfiniteLine(
            pos=dictionaries.GLOBAL_DICT[current_WAVE_TEMPLATE_AFTER][0] * 1000.0,
            angle=90,
            pen=(100, 100, 255, 255),
            movable=True,
            hoverPen="g",
        ...
        self.plot_popup_waveform.addItem(
            self.infLine_waveform_maxPca, ignoreBounds=False
        )
    ...
    def init_ssxprob_plot(self):
        self.pltData_ssxprob_popUpPlot = self.plot_popup_ssxprob.plot(
            np.zeros((0)),
            np.zeros((0)),
            name="ssXProb",
    ...
    def init_csxprob_plot(self):
        self.pltData_csxprob_popUpPlot = self.plot_popup_csxprob.plot(
            np.zeros((0)),
            np.zeros((0)),
            name="ssXProb",
            pen=pg.mkPen(color="k", width=3, style=QtCore.Qt.SolidLine),
    ...
    def connect_scatterPlot_popup_signals(self):
        ...
        self.pushBtn_scatterPlot_popup_selectatt.clicked.connect(
            self.pushBtn_scatterPlot_popup_selectatt_Clicked
        )
        self.pushBtn_scatterPlot_popup_reset.clicked.connect(
            self.pushBtn_scatterPlot_popup_reset_Clicked
        )

        self.pushBtn_scatterPlot_popup_select.clicked.connect(
            self.pushBtn_scatterPlot_popup_select_Clicked
        )
        self.pushBtn_scatterPlot_popup_clear.clicked.connect(
            self.pushBtn_scatterPlot_popup_clear_Clicked
        )
        self.comboBx_scatterPlot_popup_spike_mode.activated.connect(
            self.comboBx_scatterPlot_popup_spike_mode_Changed
        )
        self.pushBtn_scatterPlot_popup_delete.clicked.connect(
            self.pushBtn_scatterPlot_popup_delete_Clicked
        )
        self.pushBtn_scatterPlot_popup_move.clicked.connect(
            self.pushBtn_scatterPlot_popup_move_Clicked
        )
        self.comboBx_scatterPlot_popup_ss_label.activated.connect(
            self.comboBx_scatterPlot_popup_ss_label_Changed
        )
        self.comboBx_scatterPlot_popup_cs_label.activated.connect(
            self.comboBx_scatterPlot_popup_cs_label_Changed
        )
        self.pushBtn_scatterPlot_popup_setlabel.clicked.connect(
            self.pushBtn_scatterPlot_popup_setlabel_Clicked
        )

        self.pushBtn_scatterPlot_popup_select_clust.clicked.connect(
            self.pushBtn_scatterPlot_popup_select_clust_Clicked
        )
        self.pushBtn_scatterPlot_popup_prev_clust.clicked.connect(
            self.pushBtn_scatterPlot_popup_prev_clust_Clicked
        )
        self.pushBtn_scatterPlot_popup_next_clust.clicked.connect(
            self.pushBtn_scatterPlot_popup_next_clust_Clicked
        )

        self.comboBx_popup_scatterPlot_PcaNum1.activated.connect(
            self.comboBx_scatterPlot_PcaNum1_Changed
        )
        self.comboBx_popup_scatterPlot_PcaNum2.activated.connect(
            self.comboBx_scatterPlot_PcaNum2_Changed
        )

        self.infLine_waveform_minPca.sigPositionChangeFinished.connect(
            self.infLine_waveform_minPca_positionChangeFinished
        )
        self.infLine_waveform_maxPca.sigPositionChangeFinished.connect(
            self.infLine_waveform_maxPca_positionChangeFinished
        )
    ...
    def pushBtn_waveClust_Clicked(self):
        ...
        self._localDataBase["ss_index_labels_old"] = np.copy(
            self._localDataBase["ss_index_labels"]
        )
        self._localDataBase["cs_index_labels_old"] = np.copy(
            self._localDataBase["cs_index_labels"]
        )

        _minPca = self._workingDataBase[current_pca_bound_min_key][0] * 1000.0
        _maxPca = self._workingDataBase[current_pca_bound_max_key][0] * 1000.0
    ...
    def infLine_waveform_minPca_positionChangeFinished(self):
        ...
        if self.infLine_waveform_minPca.value() < (
            -self._workingDataBase[current_GLOBAL_WAVE_PLOT_BEFORE][0] * 1000.0
        ):
        ...
        if self.infLine_waveform_minPca.value() > (
            +self._workingDataBase[current_GLOBAL_WAVE_PLOT_AFTER][0] * 1000.0
        ):
            self.infLine_waveform_minPca.setValue(
                +self._workingDataBase[current_GLOBAL_WAVE_PLOT_AFTER][0] * 1000.0
            )
        ...
        self._workingDataBase[current_pca_bound_min_key][0] = (
            self.infLine_waveform_minPca.value() / 1000.0
        )
        self._workingDataBase[current_pca_bound_max_key][0] = (
            self.infLine_waveform_maxPca.value() / 1000.0
        )
    ...
    def pushBtn_scatterPlot_popup_applymethod_Clicked(self):
        ...
        _data = self._workingDataBase[current_scatter_mat_key][
            :, self._localDataBase[_current_features_key]
        ]
        ...
        if self.comboBx_scatterPlot_popup_method.currentText() == "GMM":
            ...
            self.input_dialog_gmm = PsortInputDialog(
            ...
            self.pushBtn_scatterPlot_popup_applymethod.setChecked(False)
            _idx = np.logical_not(
                lib.isNanLabel(self._localDataBase[_current_index_labels_key])
            )
            _labels = self._localDataBase[_current_index_labels_key][_idx]
            labels_unique, counts = np.unique(_labels, return_counts=True)
            iso_score = lib.isolation_score(_data, _labels, nknn=6)
            for counter_cluster, lbl in enumerate(labels_unique):
                self.pltText_scatter_list[counter_cluster].setPlainText(
                    str(lbl) + ": " + str(round(iso_score[counter_cluster], 2)) + "%"
                )
            return 0
            ...
            doubleSpinBx_params = {}
            doubleSpinBx_params["value"] = 99.0
            doubleSpinBx_params["dec"] = 2.0
            doubleSpinBx_params["step"] = 5.0
            doubleSpinBx_params["max"] = 100.0
            doubleSpinBx_params["min"] = 0.0
            self.input_dialog_outlier = PsortInputDialog(
                self, message=message, doubleSpinBx_params=doubleSpinBx_params
            )
            ...
            quant = self.input_dialog_outlier.doubleSpinBx.value() / 100.0
            ...
            if sum(ind_loi) == 1:
                ...
                knn = 20
            ind_outliers = lib.outlier_score(_data[ind_loi,], quant=quant, knn=knn)
            self._workingDataBase[current_index_selected_key] = np.zeros(
                (self._workingDataBase[current_wave_key].shape[0]), dtype=bool
            )
            self._workingDataBase[current_index_selected_key][
                np.where(ind_loi)[0][ind_outliers]
            ] = True
            # Re-plot
            self.reset_plots()
    ...
    def pushBtn_scatterPlot_popup_reset_Clicked(self):
        ...
        self._localDataBase[_current_index_labels_key][
            self._workingDataBase[current_index_key] == False
        ] = nanLabel

        self._localDataBase[_current_centers_key][0, 0] = np.mean(
            self._workingDataBase[current_scatter1_key]
        )
        self._localDataBase[_current_centers_key][0, 1] = np.mean(
        ...
        self.pltData_scatter_popUpPlot_ROI.setData(np.zeros((0)), np.zeros((0)))
        self.pltData_scatter_popUpPlot_ROI2.setData(np.zeros((0)), np.zeros((0)))
        self.pltData_waveform_popUpPlot_ROI.setData(np.zeros((0)), np.zeros((0)))
        self.pltData_waveform_popUpPlot_ROI2.setData(np.zeros((0)), np.zeros((0)))
    ...
    def pushBtn_scatterPlot_popup_selectatt_Clicked(self):
        ...
        if self._workingDataBase["umap_enable"]:
            enable_list = np.ones_like(
                self._localDataBase[_current_features_key], dtype=bool
            )
        else:
            enable_list = np.ones_like(
                self._localDataBase[_current_features_key], dtype=bool
        ...
        self.checkList = PsortChecklistDialog(
            self,
            stringlist=self._workingDataBase[current_scatter_list_key],
            checked=self._localDataBase[_current_features_key],
            enabled=enable_list,
        )
        if self.checkList.exec_() == QtWidgets.QDialog.Accepted:
            self._localDataBase[_current_features_key] = np.array(
                self.checkList.choices, dtype=bool
            )

        if self._localDataBase[_current_features_key].sum() < 2:
            self._localDataBase[_current_features_key] = np.zeros_like(
                self._workingDataBase[current_scatter_list_key], dtype=bool
            )
            self._localDataBase[_current_features_key][
                self._workingDataBase[current_pca1_index_key]
            ] = True
            self._localDataBase[_current_features_key][
                self._workingDataBase[current_pca2_index_key]
            ] = True
    ...
    def cluster_GMM(self):
        ...
        if self._localDataBase[_current_features_key].sum() > 2:
            ...
            for counter_cluster in range(n_clusters):
                ...
                init_val_ND[counter_cluster, :] = np.mean(
                    _data[index_cluster, :], axis=0
                )
            labels, centers = lib.GaussianMixture(
                input_data=_data,
                n_clusters=n_clusters,
    ...
    def pushBtn_scatterPlot_popup_select_Clicked(self):
        ...
        if (
            ...
            if self.which_plot_active == 0:
                ...
                self._workingDataBase["ss_wave_span_ROI"] = np.zeros(
                    (0), dtype=np.float32
                )
                self._workingDataBase["ss_wave_ROI"] = np.zeros((0), dtype=np.float32)
                self._workingDataBase[current_index_selected_key] = lib.inpolygon(
                    self._workingDataBase[current_scatter1_key],
                    self._workingDataBase[current_scatter2_key],
            ...
            # Waveform plot active
                ...
                for counter in range(self._workingDataBase[current_wave_key].shape[0]):
                    ...
                    _wave_span_single = self._workingDataBase[current_wave_span_key][
                        counter, :
                    ]
                    _wave_single_inpolygon = lib.inpolygon(
                        _wave_span_single * 1000.0,
                        _wave_single,
    ...
    def comboBx_scatterPlot_popup_spike_mode_Changed(self):
        ...
        self._workingDataBase[current_pca1_index_key][0] = int(
            self.comboBx_popup_scatterPlot_PcaNum1.currentIndex()
        )
        self._workingDataBase[current_pca2_index_key][0] = int(
            self.comboBx_popup_scatterPlot_PcaNum2.currentIndex()
        )

        self._localDataBase["is_ss"] = bool(
            self.comboBx_scatterPlot_popup_spike_mode.currentIndex()
        )
    ...
    def pushBtn_scatterPlot_popup_setlabel_Clicked(self):
        ...
        # Reset and remove selections
        self._workingDataBase[current_index_selected_key] = np.zeros_like(
            self._workingDataBase[current_index_selected_key], dtype=bool
        )
    ...
    def make_ss_label_list(self):
        ...
        self.comboBx_scatterPlot_popup_ss_label.addItems(
            [str(lbl) for lbl in _labels_unique]
        )
    ...
    def make_cs_label_list(self):
        ...
        self.comboBx_scatterPlot_popup_cs_label.addItems(
            [str(lbl) for lbl in _labels_unique]
        )
    ...
    def make_att_list(self):
        self._localDataBase["ss_features"] = np.zeros_like(
            self._workingDataBase["ss_scatter_list"], dtype=bool
        )
        if (
            self._workingDataBase["ss_pca1_index"]
            == self._workingDataBase["ss_pca2_index"]
        ):
            self._localDataBase["ss_features"][
                self._workingDataBase["ss_pca1_index"]
            ] = True
        ...
        self._localDataBase["cs_features"] = np.zeros_like(
            self._workingDataBase["cs_scatter_list"], dtype=bool
        )
        if (
            self._workingDataBase["cs_pca1_index"]
            == self._workingDataBase["cs_pca2_index"]
        ):
            self._localDataBase["cs_features"][
                self._workingDataBase["cs_pca1_index"]
            ] = True
    ...
    def make_clust_centers(self):
        ...
        _data[:, 1] = self._workingDataBase[current_scatter2_key]
        _centers = np.array(
            [_data[_labels == i, :].mean(axis=0) for i in _labels_unique]
        )
        ...
        self._localDataBase[_current_clust_FRs_key] = np.array(
            [
                round(
                    (_labels == i).sum()
        ...
        self._localDataBase[_current_peak_centers_key] = np.array(
            [_data_peak[_labels == i].mean(axis=0) for i in _labels_unique]
        )

    def update_ss_labels(self):
        if not (
            self._workingDataBase["ss_index"].size
            == self._localDataBase["ss_index_labels"].size
        ):
            self._localDataBase["ss_index_labels"] = np.zeros_like(
            ...
            _ind_remove = np.logical_and(
                self._workingDataBase["ss_index"] == False, _ind_nanLabel == False
            )
            _ind_add = np.logical_and(
                self._workingDataBase["ss_index"] == True, _ind_nanLabel == True
            )
    ...
    def update_cs_labels(self):
        if not (
            np.shape(self._workingDataBase["cs_index"])
            == np.shape(self._localDataBase["cs_index_labels"])
        ):
            self._localDataBase["cs_index_labels"] = np.zeros_like(
            ...
            _ind_remove = np.logical_and(
                self._workingDataBase["cs_index"] == False, _ind_nanLabel == False
            )
            _ind_add = np.logical_and(
                self._workingDataBase["cs_index"] == True, _ind_nanLabel == True
            )
    ...
    def make_scatter_list(self):
        ...
        if self._workingDataBase[current_index_key].sum() > 1:
            ...
            self.comboBx_popup_scatterPlot_PcaNum1.addItems(
                self._workingDataBase[current_scatter_list_key]
            )
            self.comboBx_popup_scatterPlot_PcaNum2.addItems(
                self._workingDataBase[current_scatter_list_key]
            )
    ...
    def reset_plots(self):
        ...
        self._workingDataBase["popUp_ROI_x"] = np.zeros((0), dtype=np.float32)
        self._workingDataBase["popUp_ROI_y"] = np.zeros((0), dtype=np.float32)
        self.pltData_scatter_popUpPlot_ROI.setData(
            self._workingDataBase["popUp_ROI_x"], self._workingDataBase["popUp_ROI_y"]
        )
        self.pltData_scatter_popUpPlot_ROI2.setData(np.zeros((0)), np.zeros((0)))
        for counter in range(len(self.list_color)):
            self.pltData_scatter_list[counter].setData(np.zeros((0)), np.zeros((0)))
            self.pltText_scatter_list[counter].hide()

        # peakhist plot
        for counter in range(len(self.list_color)):
            self.pltData_peakhist_list[counter].setData(np.arange((2)), np.zeros((1)))
            self.pltText_peakhist_list[counter].setPlainText(str(counter))
            self.pltText_peakhist_list[counter].setPos(counter, counter)
            self.pltText_peakhist_list[counter].hide()
        ...
        self._workingDataBase["popUp_ROI_x"] = np.zeros((0), dtype=np.float32)
        self._workingDataBase["popUp_ROI_y"] = np.zeros((0), dtype=np.float32)
        self.pltData_waveform_popUpPlot_ROI.setData(
            self._workingDataBase["popUp_ROI_x"], self._workingDataBase["popUp_ROI_y"]
        )
        self.pltData_waveform_popUpPlot_ROI2.setData(np.zeros((0)), np.zeros((0)))
        self.pltData_waveform_popUpPlot.setData(np.zeros((0)), np.zeros((0)))
        self.pltData_waveform_popUpPlot_selected.setData(np.zeros((0)), np.zeros((0)))
        self.pltData_waveform_popUpPlot_selected.setData(np.zeros((0)), np.zeros((0)))

        # ssxprob plot
        self.pltData_ssxprob_popUpPlot.setData(np.zeros((0)), np.zeros((0)))

        # csxprob plot
        self.pltData_csxprob_popUpPlot.setData(np.zeros((0)), np.zeros((0)))
    ...
    def extract_ss_xprob(self):
        if self._workingDataBase["ss_index"].sum() > 1:
            _idx = np.logical_not(
                lib.isNanLabel(self._localDataBase["ss_index_labels"])
            )
            _labels = self._localDataBase["ss_index_labels"][_idx]

            _ss_index_bool = self._workingDataBase["ss_index"]
            _ss_index_label = np.zeros_like(
                self._workingDataBase["ss_index"], dtype=bool
            )
            _ss_index_int = np.where(_ss_index_bool)[0]
            _ss_index_selected_int = _ss_index_int[
                _labels == self._localDataBase["ss_label_selected"]
            ]
            ...
            (
                ...
                self._workingDataBase["ss_xprob_span"],
    ...
    def extract_cs_xprob(self):
        if (
            ...
            _ss_idx = np.logical_not(
                lib.isNanLabel(self._localDataBase["ss_index_labels"])
            )
            _ss_labels = self._localDataBase["ss_index_labels"][_ss_idx]

            _cs_idx = np.logical_not(
                lib.isNanLabel(self._localDataBase["cs_index_labels"])
            )
            ...
            _cs_index_label = np.zeros_like(
                self._workingDataBase["cs_index"], dtype=bool
            )

            _ss_index_int = np.where(_ss_index_bool)[0]
            _ss_index_selected_int = _ss_index_int[
                _ss_labels == self._localDataBase["ss_label_selected"]
            ]

            _cs_index_int = np.where(_cs_index_bool)[0]
            _cs_index_selected_int = _cs_index_int[
                _cs_labels == self._localDataBase["cs_label_selected"]
            ]
            ...
            (
                ...
                self._workingDataBase["cs_xprob_span"],
            ) = lib.cross_probability(
                _cs_index_label,
                _ss_index_label,
                sample_rate=self._workingDataBase["sample_rate"][0],
    ...
    def extract_template(self):
        ...
        if self._workingDataBase[current_index_key].sum() > 0:
            ...
            _ind_begin = int(
                (
                    self._workingDataBase[current_GLOBAL_WAVE_PLOT_BEFORE_key][0]
            ...
            self._localDataBase[_current_wave_template_clusters_key] = np.mean(
                _wave[:, _window], axis=0
            )

            self._localDataBase[_current_wave_span_template_clusters_key] = np.mean(
                _wave_span[:, _window], axis=0
            )

        else:
            self._localDataBase[_current_wave_template_clusters_key] = np.zeros(
                (0), dtype=np.float32
            )
            self._localDataBase[_current_wave_span_template_clusters_key] = np.zeros(
                (0), dtype=np.float32
            )
        return 0
    ...
    def plot_scatter_popUp(self):
        ...
        for counter_cluster, lbl in enumerate(np.unique(_labels)):
            ...
            self.pltText_scatter_list[counter_cluster].setPos(
                self._localDataBase[_current_centers_key][counter_cluster, 0],
                self._localDataBase[_current_centers_key][counter_cluster, 1],
            )
            self.pltText_scatter_list[counter_cluster].setPlainText(str(lbl))
            self.pltText_scatter_list[counter_cluster].show()

            self.pltData_scatter_list[counter_cluster].setData(
                self._workingDataBase[current_scatter1_key][index_cluster,],
        ...
        self.pltData_scatter_popUpPlot_IndexSelected.setData(
    ...
    def plot_peakhist_popUp(self):
        ...
        opt_bin_edges = np.histogram_bin_edges(_data, bins="auto")
        ...
        for counter_cluster, lbl in enumerate(_labels_unique_sorted):
            ...
            num_bin = max(
                int(np.rint((_data_hist.max() - _data_hist.min()) / bin_dist).item()), 1
            )
            peak_hist, peak_bin_edges = np.histogram(_data_hist, bins=num_bin)

            if counter_cluster == 0:
                peak_max = np.max(peak_hist)
                text_pos = 1.1 * peak_max
            else:
                text_pos = max(np.max(peak_hist), 0.3 * peak_max)

            # set text
            self.pltText_peakhist_list[index_plot].setPlainText(
                "FR "
                + str(lbl)
                + ": "
                + str(self._localDataBase[_current_clust_FRs_key][index_plot])
                + " Hz"
            )
            self.pltText_peakhist_list[index_plot].setPos(
                self._localDataBase[_current_peak_centers_key][index_plot], text_pos
            )
            self.pltText_peakhist_list[index_plot].show()

            # set data
            self.pltData_peakhist_list[index_plot].setData(
                peak_bin_edges.ravel(), peak_hist.ravel()
            )

        self.viewBox_peakhist_popUpPlot.setLimits(yMin=0.0, minYRange=0.0)
        self.viewBox_peakhist_popUpPlot.autoRange()
        return 0
    ...
    def plot_waveform_popUp(self):
        ...
        _index_label = _labels == self._localDataBase[_current_label_selected_key][0]
        ...
        self.pltData_waveform_popUpPlot.setData(
            wave_span.ravel() * 1000.0, waveform.ravel(), connect="finite"
        )
        ...
        nanLabel_array = np.full(
            (self._workingDataBase[current_wave_key][_index_selected, :].shape[0]),
            np.NaN,
        ).reshape(-1, 1)
        _waveform_selected = np.append(
            self._workingDataBase[current_wave_key][_index_selected, :],
            nanLabel_array,
            axis=1,
        )
        _wave_span_selected = np.append(
            self._workingDataBase[current_wave_span_key][_index_selected, :],
            nanLabel_array,
            axis=1,
        )
        self.pltData_waveform_popUpPlot_selected.setData(
            _wave_span_selected.ravel() * 1000.0,
            _waveform_selected.ravel(),
            connect="finite",
        )
        self.pltData_waveform_popUpPlot_template.setData(
            self._localDataBase[_current_wave_span_template_clusters_key] * 1000.0,
    ...
    def plot_ssxprob_popUp(self):
        self.pltData_ssxprob_popUpPlot.setData(
            self._workingDataBase["ss_xprob_span"] * 1000.0,
            self._workingDataBase["ss_xprob"],
            connect="finite",
        )
        self.viewBox_ssxprob_popUpPlot.autoRange()
        self.viewBox_ssxprob_popUpPlot.setLimits(yMin=0.0, minYRange=0.0)
        vb_range = self.viewBox_ssxprob_popUpPlot.viewRange()
        self.viewBox_ssxprob_popUpPlot.setYRange(0.0, vb_range[1][1])
    ...
    def plot_csxprob_popUp(self):
        self.pltData_csxprob_popUpPlot.setData(
            self._workingDataBase["cs_xprob_span"] * 1000.0,
            self._workingDataBase["cs_xprob"],
            connect="finite",
        )
        self.viewBox_csxprob_popUpPlot.autoRange()
        self.viewBox_csxprob_popUpPlot.setLimits(yMin=0.0, minYRange=0.0)
        vb_range = self.viewBox_csxprob_popUpPlot.viewRange()
        self.viewBox_csxprob_popUpPlot.setYRange(0.0, vb_range[1][1])
    ...
    def popUpPlot_mouseClicked_scatter(self, evt):
        ...
        if evt[0].button() == QtCore.Qt.LeftButton:
            ...
            if self.plot_popup_scatter.sceneBoundingRect().contains(pos):
                ...
                if (
                    self._localDataBase["flag_gmm"][0]
                    and self.pushBtn_scatterPlot_popup_applymethod.isChecked()
                ):
                    self.pltData_scatter_popUpPlot_ROI.setData(
                        self._workingDataBase["popUp_ROI_x"],
                        self._workingDataBase["popUp_ROI_y"],
                    ...
                    if self._workingDataBase["popUp_ROI_x"].size > 2:
                        self.pltData_scatter_popUpPlot_ROI2.setData(
    ...
    def popUpPlot_mouseClicked_waveform(self, evt):
        ...
        if evt[0].button() == QtCore.Qt.LeftButton:
            ...
            if self.plot_popup_waveform.sceneBoundingRect().contains(pos):
                ...
                if self._workingDataBase["popUp_ROI_x"].size > 2:
                    self.pltData_waveform_popUpPlot_ROI2.setData(
                        self._workingDataBase["popUp_ROI_x"][[0, -1],],
                        self._workingDataBase["popUp_ROI_y"][[0, -1],],
                        pen=pg.mkPen(color="m", width=2, style=QtCore.Qt.DotLine),
                    )
    ...
    def popUp_task_cancelled(self):
        self.scatterPoints_popUp_reset_ROI()
        self._localDataBase["ss_index_labels"] = np.copy(
            self._localDataBase["ss_index_labels_old"]
        )
        self._localDataBase["cs_index_labels"] = np.copy(
            self._localDataBase["cs_index_labels_old"]
        )
        return 0
    ...
    def set_GMM_crosshair(self, isActive):
        if isActive:
            ...
            self.infLine_popUpPlot_hLine.setValue(0.0)

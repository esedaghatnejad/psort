...
class PsortGuiWidget(QMainWindow):
    ...
    def build_mainwin_SsPanel(self):
        ...
        self.pushBtn_mainwin_SsPanel_buttons_SsDelete.\
            setIcon(QtGui.QIcon(os.path.join(lib.PROJECT_FOLDER, 'icons', '067-trash-blue.png')))
        ...
        self.pushBtn_mainwin_SsPanel_buttons_SsKeep.\
            setIcon(QtGui.QIcon(os.path.join(lib.PROJECT_FOLDER, 'icons', '023-download-blue.png')))
        ...
        self.pushBtn_mainwin_SsPanel_buttons_SsMoveToCs.\
            setIcon(QtGui.QIcon(os.path.join(lib.PROJECT_FOLDER, 'icons', '084-shuffle-right-blue.png')))
        ...
        self.pushBtn_mainwin_SsPanel_buttons_SsDeselect.\
            setIcon(QtGui.QIcon(os.path.join(lib.PROJECT_FOLDER, 'icons', '030-forbidden-blue.png')))
    ...
    def build_toolbar(self):
        ...
        self.actionBtn_toolbar_next = \
            QAction(QtGui.QIcon(os.path.join(lib.PROJECT_FOLDER, 'icons', '071-right-arrow.png')), "Next Slot", self)
        self.actionBtn_toolbar_previous = \
            QAction(QtGui.QIcon(os.path.join(lib.PROJECT_FOLDER, 'icons', '036-left-arrow.png')), "Previous Slot", self)
        self.actionBtn_toolbar_refresh = \
            QAction(QtGui.QIcon(os.path.join(lib.PROJECT_FOLDER, 'icons', '068-recycling.png')), "Refresh Slot", self)
        self.actionBtn_toolbar_load = \
            QAction(QtGui.QIcon(os.path.join(lib.PROJECT_FOLDER, 'icons', '029-folder.png')), "Open File...", self)
        self.actionBtn_toolbar_save = \
            QAction(QtGui.QIcon(os.path.join(lib.PROJECT_FOLDER, 'icons', '073-diskette.png')), "Save Session", self)
        self.actionBtn_toolbar_undo = \
            QAction(QtGui.QIcon(os.path.join(lib.PROJECT_FOLDER, 'icons', '068-undo.png')), "Undo", self)
        self.actionBtn_toolbar_redo = \
            QAction(QtGui.QIcon(os.path.join(lib.PROJECT_FOLDER, 'icons', '068-redo.png')), "Redo", self)
    ...
    def build_menubar(self):
        ...
        self.actionBtn_menubar_file_lfp     = QAction("Sideload LFP...", self)

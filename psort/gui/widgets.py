...
class PsortGuiWidget(QMainWindow, ):
    ...
    #     self.build_SsCsPanel()
    #     # add layouts to the layout_mainwin
    #     self.layout_mainwin.addWidget(self.widget_filterPanel)
    #     self.layout_mainwin.addWidget(self.widget_rawSignalPanel)
    #     self.layout_mainwin.addWidget(self.widget_SsCsPanel)
    #     # the size of filterPanel is fixed

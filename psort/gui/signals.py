...
class PsortGuiSignals(PsortGuiWidget):
    ...
    def init_workingDataBase(self):
        ...
        self.comboBx_mainwin_filterPanel_SsFast.currentIndexChanged.disconnect(
            self.onfilterPanel_SsFast_IndexChanged
        )
        self.comboBx_mainwin_filterPanel_SsFast.setCurrentIndex(0)
        self.comboBx_mainwin_filterPanel_SsFast.currentIndexChanged.connect(
            self.onfilterPanel_SsFast_IndexChanged
        )

        self.comboBx_mainwin_filterPanel_CsSlow.currentIndexChanged.disconnect(
            self.onfilterPanel_CsSlow_IndexChanged
        )
        self.comboBx_mainwin_filterPanel_CsSlow.setCurrentIndex(0)
        self.comboBx_mainwin_filterPanel_CsSlow.currentIndexChanged.connect(
            self.onfilterPanel_CsSlow_IndexChanged
        )

        self.pushBtn_mainwin_SsPanel_plots_SsWaveBtn_learnWaveform.clicked.disconnect(
            self.onSsPanel_learnWave_Clicked
        )
        self.pushBtn_mainwin_SsPanel_plots_SsWaveBtn_learnWaveform.setChecked(False)
        self.pushBtn_mainwin_SsPanel_plots_SsWaveBtn_learnWaveform.clicked.connect(
            self.onSsPanel_learnWave_Clicked
        )

        self.pushBtn_mainwin_CsPanel_plots_CsWaveBtn_learnWaveform.clicked.disconnect(
            self.onCsPanel_learnWave_Clicked
        )
        self.pushBtn_mainwin_CsPanel_plots_CsWaveBtn_learnWaveform.setChecked(False)
        self.pushBtn_mainwin_CsPanel_plots_CsWaveBtn_learnWaveform.clicked.connect(
            self.onCsPanel_learnWave_Clicked
        )

        self.comboBx_mainwin_filterPanel_CsAlign.currentIndexChanged.disconnect(
            self.onfilterPanel_CsAlign_IndexChanged
        )
        self.comboBx_mainwin_filterPanel_CsAlign.setCurrentIndex(0)
        self.comboBx_mainwin_filterPanel_CsAlign.currentIndexChanged.connect(
            self.onfilterPanel_CsAlign_IndexChanged
        )

        self.comboBx_mainwin_SsPanel_plots_SsPcaPlot_PcaNum1.activated.disconnect(
            self.onSsPanel_PcaNum1_IndexChanged
        )
        self.comboBx_mainwin_SsPanel_plots_SsPcaPlot_PcaNum1.setCurrentIndex(0)
        self.comboBx_mainwin_SsPanel_plots_SsPcaPlot_PcaNum1.activated.connect(
            self.onSsPanel_PcaNum1_IndexChanged
        )

        self.comboBx_mainwin_SsPanel_plots_SsPcaPlot_PcaNum2.activated.disconnect(
            self.onSsPanel_PcaNum2_IndexChanged
        )
        self.comboBx_mainwin_SsPanel_plots_SsPcaPlot_PcaNum2.setCurrentIndex(1)
        self.comboBx_mainwin_SsPanel_plots_SsPcaPlot_PcaNum2.activated.connect(
            self.onSsPanel_PcaNum2_IndexChanged
        )

        self.comboBx_mainwin_CsPanel_plots_CsPcaPlot_PcaNum1.activated.disconnect(
            self.onCsPanel_PcaNum1_IndexChanged
        )
        self.comboBx_mainwin_CsPanel_plots_CsPcaPlot_PcaNum1.setCurrentIndex(0)
        self.comboBx_mainwin_CsPanel_plots_CsPcaPlot_PcaNum1.activated.connect(
            self.onCsPanel_PcaNum1_IndexChanged
        )

        self.comboBx_mainwin_CsPanel_plots_CsPcaPlot_PcaNum2.activated.disconnect(
            self.onCsPanel_PcaNum2_IndexChanged
        )
        self.comboBx_mainwin_CsPanel_plots_CsPcaPlot_PcaNum2.setCurrentIndex(1)
        self.comboBx_mainwin_CsPanel_plots_CsPcaPlot_PcaNum2.activated.connect(
            self.onCsPanel_PcaNum2_IndexChanged
        )

        self.actionBtn_menubar_tools_umap.triggered.disconnect(
            self.onMenubar_umap_ButtonClick
        )
        self.actionBtn_menubar_tools_umap.setChecked(False)
        self.actionBtn_menubar_tools_umap.triggered.connect(
            self.onMenubar_umap_ButtonClick
        )
    ...
    def init_plots(self):
        # rawSignal
        self.pltData_rawSignal_Ss = self.plot_mainwin_rawSignalPanel_rawSignal.plot(
            np.zeros((0)),
            np.zeros((0)),
            name="SS",
            pen=pg.mkPen(color="k", width=1, style=QtCore.Qt.SolidLine),
        )
        self.pltData_rawSignal_Cs = self.plot_mainwin_rawSignalPanel_rawSignal.plot(
            np.zeros((0)),
            np.zeros((0)),
            name="CS",
        ...
        # infLine
        self.infLine_rawSignal_SsThresh = pg.InfiniteLine(
            pos=-100.0,
            angle=0,
            pen=(100, 100, 255, 255),
            movable=True,
        ...
        self.plot_mainwin_rawSignalPanel_rawSignal.addItem(
            self.infLine_rawSignal_SsThresh, ignoreBounds=True
        )
        self.infLine_rawSignal_CsThresh = pg.InfiniteLine(
            pos=+100.0,
            angle=0,
            pen=(255, 100, 100, 255),
            movable=True,
        ...
        self.plot_mainwin_rawSignalPanel_rawSignal.addItem(
            self.infLine_rawSignal_CsThresh, ignoreBounds=True
        )
        self.viewBox_rawSignal = self.plot_mainwin_rawSignalPanel_rawSignal.getViewBox()
        self.viewBox_rawSignal.autoRange()
        # ssPeak
        self.pltData_SsPeak = self.plot_mainwin_rawSignalPanel_SsPeak.plot(
            np.arange(2),
            np.zeros((1)),
            name="ssPeak",
            stepMode=True,
        ...
        self.infLine_SsPeak = pg.InfiniteLine(
            pos=-100.0,
            angle=90,
            pen=(100, 100, 255, 255),
            movable=True,
        ...
        self.plot_mainwin_rawSignalPanel_SsPeak.addItem(
            self.infLine_SsPeak, ignoreBounds=False
        )
        self.viewBox_SsPeak = self.plot_mainwin_rawSignalPanel_SsPeak.getViewBox()
        self.viewBox_SsPeak.autoRange()
        # csPeak
        self.pltData_CsPeak = self.plot_mainwin_rawSignalPanel_CsPeak.plot(
            np.arange(2),
            np.zeros((1)),
            name="csPeak",
            stepMode=True,
        ...
        self.infLine_CsPeak = pg.InfiniteLine(
            pos=+100.0,
            angle=90,
            pen=(255, 100, 100, 255),
            movable=True,
        ...
        self.plot_mainwin_rawSignalPanel_CsPeak.addItem(
            self.infLine_CsPeak, ignoreBounds=False
        )
        self.viewBox_CsPeak = self.plot_mainwin_rawSignalPanel_CsPeak.getViewBox()
        self.viewBox_CsPeak.autoRange()
        # ssWave
        self.pltData_SsWave = self.plot_mainwin_SsPanel_plots_SsWave.plot(
            np.zeros((0)),
            np.zeros((0)),
            name="ssWave",
            pen=pg.mkPen(color=(0, 0, 0, 20), width=1, style=QtCore.Qt.SolidLine),
        )
        self.pltData_SsWaveSelected = self.plot_mainwin_SsPanel_plots_SsWave.plot(
            np.zeros((0)),
            np.zeros((0)),
            name="ssWaveSelected",
            pen=pg.mkPen(color=(0, 0, 255, 255), width=1, style=QtCore.Qt.SolidLine),
        )
        self.pltData_SsWaveTemplate = self.plot_mainwin_SsPanel_plots_SsWave.plot(
            np.zeros((0)),
            np.zeros((0)),
            name="ssWaveTemplate",
            pen=pg.mkPen(color=(0, 100, 255, 200), width=3, style=QtCore.Qt.SolidLine),
        )
        self.infLine_SsWave_minPca = pg.InfiniteLine(
            pos=-self._workingDataBase["GLOBAL_WAVE_TEMPLATE_SS_BEFORE"][0] * 1000.0,
            angle=90,
            pen=(100, 100, 255, 255),
            movable=True,
            hoverPen="g",
        ...
        self.plot_mainwin_SsPanel_plots_SsWave.addItem(
            self.infLine_SsWave_minPca, ignoreBounds=False
        )
        self.infLine_SsWave_maxPca = pg.InfiniteLine(
            pos=self._workingDataBase["GLOBAL_WAVE_TEMPLATE_SS_AFTER"][0] * 1000.0,
            angle=90,
            pen=(100, 100, 255, 255),
            movable=True,
            hoverPen="g",
        ...
        self.plot_mainwin_SsPanel_plots_SsWave.addItem(
            self.infLine_SsWave_maxPca, ignoreBounds=False
        )
        self.viewBox_SsWave = self.plot_mainwin_SsPanel_plots_SsWave.getViewBox()
        self.viewBox_SsWave.autoRange()
        # ssIfr
        self.pltData_SsIfr = self.plot_mainwin_SsPanel_plots_SsIfr.plot(
            np.arange(2),
            np.zeros((1)),
            name="ssIfr",
            stepMode=True,
        ...
        self.plot_mainwin_SsPanel_plots_SsIfr.addItem(
            self.infLine_SsIfr, ignoreBounds=False
        )
        self.viewBox_SsIfr = self.plot_mainwin_SsPanel_plots_SsIfr.getViewBox()
        self.viewBox_SsIfr.autoRange()
        # ssPca
        self.pltData_SsPca = self.plot_mainwin_SsPanel_plots_SsPca.plot(
            np.zeros((0)),
            np.zeros((0)),
            name="ssPca",
            pen=None,
            symbol="o",
            symbolSize=2,
            symbolBrush=(0, 0, 0, 100),
            symbolPen=None,
        )
        self.pltData_SsPcaSelected = self.plot_mainwin_SsPanel_plots_SsPca.plot(
            np.zeros((0)),
            np.zeros((0)),
            name="ssPcaSelected",
            pen=None,
        ...
        # ssXProb
        self.pltData_SsXProb = self.plot_mainwin_SsPanel_plots_SsXProb.plot(
            np.zeros((0)),
            np.zeros((0)),
            name="ssXProb",
        ...
        # csWave
        self.pltData_CsWave = self.plot_mainwin_CsPanel_plots_CsWave.plot(
            np.zeros((0)),
            np.zeros((0)),
            name="csWave",
            pen=pg.mkPen(color=(0, 0, 0, 200), width=1, style=QtCore.Qt.SolidLine),
        )
        self.pltData_CsWaveSelected = self.plot_mainwin_CsPanel_plots_CsWave.plot(
            np.zeros((0)),
            np.zeros((0)),
            name="csWaveSelected",
            pen=pg.mkPen(color=(255, 0, 0, 255), width=2, style=QtCore.Qt.SolidLine),
        )
        self.pltData_CsWaveTemplate = self.plot_mainwin_CsPanel_plots_CsWave.plot(
            np.zeros((0)),
            np.zeros((0)),
            name="csWaveTemplate",
            pen=pg.mkPen(color=(255, 100, 0, 200), width=4, style=QtCore.Qt.SolidLine),
        )
        self.infLine_CsWave_minPca = pg.InfiniteLine(
            pos=-self._workingDataBase["GLOBAL_WAVE_TEMPLATE_CS_BEFORE"][0] * 1000.0,
            angle=90,
            pen=(255, 100, 100, 255),
            movable=True,
            hoverPen="g",
        ...
        self.plot_mainwin_CsPanel_plots_CsWave.addItem(
            self.infLine_CsWave_minPca, ignoreBounds=False
        )
        self.infLine_CsWave_maxPca = pg.InfiniteLine(
            pos=self._workingDataBase["GLOBAL_WAVE_TEMPLATE_CS_AFTER"][0] * 1000.0,
            angle=90,
            pen=(255, 100, 100, 255),
            movable=True,
            hoverPen="g",
        ...
        self.plot_mainwin_CsPanel_plots_CsWave.addItem(
            self.infLine_CsWave_maxPca, ignoreBounds=False
        )
        self.viewBox_CsWave = self.plot_mainwin_CsPanel_plots_CsWave.getViewBox()
        self.viewBox_CsWave.autoRange()
        # csIfr
        self.pltData_CsIfr = self.plot_mainwin_CsPanel_plots_CsIfr.plot(
            np.arange(2),
            np.zeros((1)),
            name="csIfr",
            stepMode=True,
        ...
        self.plot_mainwin_CsPanel_plots_CsIfr.addItem(
            self.infLine_CsIfr, ignoreBounds=False
        )
        self.viewBox_CsIfr = self.plot_mainwin_CsPanel_plots_CsIfr.getViewBox()
        self.viewBox_CsIfr.autoRange()
        # csPca
        self.pltData_CsPca = self.plot_mainwin_CsPanel_plots_CsPca.plot(
            np.zeros((0)),
            np.zeros((0)),
            name="csPca",
            pen=None,
            symbol="o",
            symbolSize=3,
            symbolBrush=(0, 0, 0, 200),
            symbolPen=None,
        )
        self.pltData_CsPcaSelected = self.plot_mainwin_CsPanel_plots_CsPca.plot(
            np.zeros((0)),
            np.zeros((0)),
            name="csPcaSelected",
            pen=None,
        ...
        # csXProb
        self.pltData_CsXProb = self.plot_mainwin_CsPanel_plots_CsXProb.plot(
            np.zeros((0)),
            np.zeros((0)),
            name="csXProb",
    ...
    def connect_menubar_signals(self):
        ...
        self.actionBtn_menubar_file_lfp.triggered.connect(
            self.onMenubar_lfp_ButtonClick
        )
        self.actionBtn_menubar_file_restart.triggered.connect(
            self.onMenubar_restart_ButtonClick
        )
        self.actionBtn_menubar_file_save.triggered.connect(
            self.onToolbar_save_ButtonClick
        )
        self.actionBtn_menubar_file_exit.triggered.connect(sys.exit)
        self.actionBtn_menubar_tools_prefrences.triggered.connect(
            self.onMenubar_prefrences_ButtonClick
        )
        self.actionBtn_menubar_tools_umap.triggered.connect(
            self.onMenubar_umap_ButtonClick
        )
        self.actionBtn_menubar_tools_cellSummary.triggered.connect(
            self.onMenubar_cellSummary_ButtonClick
        )
        self.actionBtn_menubar_tools_realign_CS.triggered.connect(
            self.onMenubar_realignCS_ButtonClick
        )
        self.actionBtn_menubar_addons_commonAvg.triggered.connect(
            self.onMenubar_commonAvg_ButtonClick
        )
        return 0
    ...
    def connect_toolbar_signals(self):
        ...
        self.actionBtn_toolbar_undo.triggered.connect(self.undoRedo_undo)
        self.actionBtn_toolbar_redo.triggered.connect(self.undoRedo_redo)
        return 0

    def connect_plot_signals(self):
        self.infLine_rawSignal_SsThresh.sigPositionChangeFinished.connect(
            self.onInfLineSsThresh_positionChangeFinished
        )
        self.infLine_rawSignal_SsThresh.sigPositionChanged.connect(
            self.onInfLineSsThresh_positionChanged
        )
        self.infLine_SsPeak.sigPositionChanged.connect(
            self.onInfLineSsPeak_positionChanged
        )
        self.infLine_SsPeak.sigPositionChangeFinished.connect(
            self.onInfLineSsPeak_positionChangeFinished
        )
        self.infLine_rawSignal_CsThresh.sigPositionChangeFinished.connect(
            self.onInfLineCsThresh_positionChangeFinished
        )
        self.infLine_rawSignal_CsThresh.sigPositionChanged.connect(
            self.onInfLineCsThresh_positionChanged
        )
        self.infLine_CsPeak.sigPositionChanged.connect(
            self.onInfLineCsPeak_positionChanged
        )
        self.infLine_CsPeak.sigPositionChangeFinished.connect(
            self.onInfLineCsPeak_positionChangeFinished
        )
        self.infLine_SsWave_minPca.sigPositionChangeFinished.connect(
            self.onInfLineSsWaveMinPca_positionChangeFinished
        )
        self.infLine_SsWave_maxPca.sigPositionChangeFinished.connect(
            self.onInfLineSsWaveMaxPca_positionChangeFinished
        )
        self.infLine_CsWave_minPca.sigPositionChangeFinished.connect(
            self.onInfLineCsWaveMinPca_positionChangeFinished
        )
        self.infLine_CsWave_maxPca.sigPositionChangeFinished.connect(
    ...
    def connect_filterPanel_signals(self):
        ...
        self.txtedit_mainwin_filterPanel_ssFilter_min.valueChanged.connect(
            self.onfilterPanel_ssFilterMin_ValueChanged
        )
        self.txtedit_mainwin_filterPanel_ssFilter_max.valueChanged.connect(
            self.onfilterPanel_ssFilterMax_ValueChanged
        )
        self.txtedit_mainwin_filterPanel_csFilter_min.valueChanged.connect(
            self.onfilterPanel_csFilterMin_ValueChanged
        )
        self.txtedit_mainwin_filterPanel_csFilter_max.valueChanged.connect(
            self.onfilterPanel_csFilterMax_ValueChanged
        )
        return 0

    def connect_rawSignalPanel_signals(self):
        self.txtedit_mainwin_rawSignalPanel_SsThresh.valueChanged.connect(
            self.onRawSignal_SsThresh_ValueChanged
        )
        self.txtedit_mainwin_rawSignalPanel_CsThresh.valueChanged.connect(
            self.onRawSignal_CsThresh_ValueChanged
        )
        self.pushBtn_mainwin_rawSignalPanel_SsAutoThresh.clicked.connect(
            self.onRawSignal_SsAutoThresh_Clicked
        )
        self.pushBtn_mainwin_rawSignalPanel_CsAutoThresh.clicked.connect(
            self.onRawSignal_CsAutoThresh_Clicked
        )
        return 0

    def connect_ssPanel_signals(self):
        self.pushBtn_mainwin_SsPanel_plots_SsPcaBtn_selectPcaData.clicked.connect(
            self.onSsPanel_selectPcaData_Clicked
        )
        self.pushBtn_mainwin_SsPanel_plots_SsPcaBtn_waveClust.clicked.connect(
            self.onSsPanel_waveClust_Clicked
        )
        self.pushBtn_mainwin_SsPanel_plots_SsWaveBtn_selectWave.clicked.connect(
            self.onSsPanel_selectWave_Clicked
        )
        self.pushBtn_mainwin_SsPanel_plots_SsWaveBtn_waveDissect.clicked.connect(
            self.onSsPanel_waveDissect_Clicked
        )
        self.pushBtn_mainwin_SsPanel_plots_SsWaveBtn_learnWaveform.clicked.connect(
            self.onSsPanel_learnWave_Clicked
        )
        self.pushBtn_mainwin_SsPanel_buttons_SsDeselect.clicked.connect(
            self.onSsPanel_deselect_Clicked
        )
        self.pushBtn_mainwin_SsPanel_buttons_SsDelete.clicked.connect(
            self.onSsPanel_delete_Clicked
        )
        self.pushBtn_mainwin_SsPanel_buttons_SsKeep.clicked.connect(
            self.onSsPanel_keep_Clicked
        )
        self.pushBtn_mainwin_SsPanel_buttons_SsMoveToCs.clicked.connect(
            self.onSsPanel_moveToCs_Clicked
        )
        self.comboBx_mainwin_SsPanel_plots_SsPcaPlot_PcaNum1.activated.connect(
            self.onSsPanel_PcaNum1_IndexChanged
        )
    ...
    def connect_csPanel_signals(self):
        self.pushBtn_mainwin_CsPanel_plots_CsPcaBtn_selectPcaData.clicked.connect(
            self.onCsPanel_selectPcaData_Clicked
        )
        self.pushBtn_mainwin_CsPanel_plots_CsPcaBtn_waveClust.clicked.connect(
            self.onCsPanel_waveClust_Clicked
        )
        self.pushBtn_mainwin_CsPanel_plots_CsWaveBtn_selectWave.clicked.connect(
            self.onCsPanel_selectWave_Clicked
        )
        self.pushBtn_mainwin_CsPanel_plots_CsWaveBtn_waveDissect.clicked.connect(
            self.onCsPanel_waveDissect_Clicked
        )
        self.pushBtn_mainwin_CsPanel_plots_CsWaveBtn_learnWaveform.clicked.connect(
            self.onCsPanel_learnWave_Clicked
        )
        self.pushBtn_mainwin_CsPanel_buttons_CsDeselect.clicked.connect(
            self.onCsPanel_deselect_Clicked
        )
        self.pushBtn_mainwin_CsPanel_buttons_CsDelete.clicked.connect(
            self.onCsPanel_delete_Clicked
        )
        self.pushBtn_mainwin_CsPanel_buttons_CsKeep.clicked.connect(
            self.onCsPanel_keep_Clicked
        )
        self.pushBtn_mainwin_CsPanel_buttons_CsMoveToSs.clicked.connect(
            self.onCsPanel_moveToSs_Clicked
        )
        self.comboBx_mainwin_CsPanel_plots_CsPcaPlot_PcaNum1.activated.connect(
            self.onCsPanel_PcaNum1_IndexChanged
        )
    ...
    def onToolbar_slotNumCurrent_ValueChanged(self):
        ...
        self.txtlabel_toolbar_slotNumTotal.setText(
            "/ "
            + str(self.psortDataBase.get_total_slot_num())
            + "("
    ...
    def onMenubar_umap_ButtonClick(self):
        self._workingDataBase["umap_enable"][
            0
    ...
    def onMenubar_cellSummary_ButtonClick(self):
        ...
        self.menubar_cellSummary = CellSummarySignals(
    ...
    def onMenubar_realignCS_ButtonClick(self):
        ...
        ) or not (self._workingDataBase["csLearnTemp_mode"][0]):
    ...
    def onInfLineSsThresh_positionChangeFinished(self):
        self.txtedit_mainwin_rawSignalPanel_SsThresh.setValue(
            abs(self.infLine_rawSignal_SsThresh.value())
        )
    ...
    def onInfLineCsThresh_positionChangeFinished(self):
        self.txtedit_mainwin_rawSignalPanel_CsThresh.setValue(
            abs(self.infLine_rawSignal_CsThresh.value())
        )
    ...
    def onInfLineSsWaveMinPca_positionChangeFinished(self):
        ...
        if self.infLine_SsWave_minPca.value() < (
            -self._workingDataBase["GLOBAL_WAVE_PLOT_SS_BEFORE"][0] * 1000.0
        ):
        ...
        if self.infLine_SsWave_minPca.value() > (
            +self._workingDataBase["GLOBAL_WAVE_PLOT_SS_AFTER"][0] * 1000.0
        ):
            self.infLine_SsWave_minPca.setValue(
                +self._workingDataBase["GLOBAL_WAVE_PLOT_SS_AFTER"][0] * 1000.0
            )
        ...
        self._workingDataBase["ss_pca_bound_min"][0] = (
            self.infLine_SsWave_minPca.value() / 1000.0
        )
        self._workingDataBase["ss_pca_bound_max"][0] = (
            self.infLine_SsWave_maxPca.value() / 1000.0
        )
    ...
    def onInfLineCsWaveMinPca_positionChangeFinished(self):
        ...
        if self.infLine_CsWave_minPca.value() < (
            -self._workingDataBase["GLOBAL_WAVE_PLOT_CS_BEFORE"][0] * 1000.0
        ):
        ...
        if self.infLine_CsWave_minPca.value() > (
            +self._workingDataBase["GLOBAL_WAVE_PLOT_CS_AFTER"][0] * 1000.0
        ):
            self.infLine_CsWave_minPca.setValue(
                +self._workingDataBase["GLOBAL_WAVE_PLOT_CS_AFTER"][0] * 1000.0
            )
        ...
        self._workingDataBase["cs_pca_bound_min"][0] = (
            self.infLine_CsWave_minPca.value() / 1000.0
        )
        self._workingDataBase["cs_pca_bound_max"][0] = (
            self.infLine_CsWave_maxPca.value() / 1000.0
        )
        if not (self._workingDataBase["flag_tools_prefrences"][0]):
            signals_lib.extract_cs_pca(self._workingDataBase)
            signals_lib.extract_cs_scatter(self._workingDataBase)
    ...
    def onSsPanel_PcaNum1_IndexChanged(self):
        if (self.comboBx_mainwin_SsPanel_plots_SsPcaPlot_PcaNum1.count() >= 2) and (
            ...
            self._workingDataBase["ss_pca1_index"][
                0
    ...
    def onSsPanel_PcaNum2_IndexChanged(self):
        if (self.comboBx_mainwin_SsPanel_plots_SsPcaPlot_PcaNum2.count() >= 2) and (
            ...
            self._workingDataBase["ss_pca2_index"][
                0
    ...
    def onCsPanel_PcaNum1_IndexChanged(self):
        if (self.comboBx_mainwin_CsPanel_plots_CsPcaPlot_PcaNum1.count() >= 2) and (
            ...
            self._workingDataBase["cs_pca1_index"][
                0
    ...
    def onCsPanel_PcaNum2_IndexChanged(self):
        if (self.comboBx_mainwin_CsPanel_plots_CsPcaPlot_PcaNum2.count() >= 2) and (
            ...
            self._workingDataBase["cs_pca2_index"][
                0
    ...
    def onRawSignal_SsThresh_ValueChanged(self):
        ...
        self.infLine_SsPeak.setValue(self._workingDataBase["ss_threshold"][0] * _sign)
        self.viewBox_SsPeak.autoRange()
        return 0
    ...
    def onRawSignal_CsThresh_ValueChanged(self):
        ...
        self.infLine_CsPeak.setValue(self._workingDataBase["cs_threshold"][0] * _sign)
        self.viewBox_CsPeak.autoRange()
        return 0
    ...
    def onSsPanel_learnWave_Clicked(self):
        ...
        ) and (self._workingDataBase["ss_index"].sum() < 1):
            self.pushBtn_mainwin_SsPanel_plots_SsWaveBtn_learnWaveform.setChecked(False)
    ...
    def onCsPanel_learnWave_Clicked(self):
        if (
            self.pushBtn_mainwin_CsPanel_plots_CsWaveBtn_learnWaveform.isChecked()
        ) and (self._workingDataBase["cs_index"].sum() < 1):
            self.pushBtn_mainwin_CsPanel_plots_CsWaveBtn_learnWaveform.setChecked(False)
        self._workingDataBase["csLearnTemp_mode"][
            0
        ] = self.pushBtn_mainwin_CsPanel_plots_CsWaveBtn_learnWaveform.isChecked()
        signals_lib.extract_cs_template(self._workingDataBase)
        # signals_lib.extract_ss_similarity(self._workingDataBase)
    ...
    def load_process_start(self):
        ...
        if file_ext == ".smr":
            ...
            self.input_dialog = PsortInputDialog(
                self, message=message, doubleSpinBx_params=doubleSpinBx_params
            )
    ...
    def load_process_finished(self, ch_data, ch_time, sample_rate):
        currentDT = datetime.datetime.now()
        self.txtlabel_statusBar.setText(
            currentDT.strftime("%H:%M:%S") + " Loaded data."
        )
        ...
        _, _, _, file_ext, _ = lib.get_fullPath_components(file_fullPath)
        if file_ext == ".psort":
            self.psortDataBase.load_dataBase(
                file_fullPath, grandDataBase=ch_data, isCommonAverage=False
            )
        ...
        if isCommonAverage:
            self.psortDataBase.load_dataBase(
                file_fullPath, ch_data=ch_data, isCommonAverage=True
            )
            self.load_process_finished_complement()
            return 0

        if isLfpSignal:
            self.psortDataBase.sideload_lfp(
                file_fullPath, ch_data=ch_data, ch_time=ch_time, sample_rate=sample_rate
            )
    ...
    def load_process_finished_complement_lfp(self):
        ...
        if ch_lfp_max < 100.0:
            ...
            doubleSpinBx_params = {}
            doubleSpinBx_params["value"] = 1000.0
            doubleSpinBx_params["dec"] = 1
            doubleSpinBx_params["step"] = 10.0
            doubleSpinBx_params["max"] = 1e5
            doubleSpinBx_params["min"] = 1e-8
        ...
        self._workingDataBase["ch_lfp"] = deepcopy(
            psort_grandDataBase[-1]["ch_lfp"][
    ...
    def plot_rawSignal_CsIndex(self):
        self.pltData_rawSignal_CsInedx.setData(
    ...
    def plot_rawSignal_SsIndexSelected(self):
        ...
        self.pltData_rawSignal_SsInedxSelected.setData(
    ...
    def plot_rawSignal_CsIndexSelected(self):
        ...
        self.pltData_rawSignal_CsInedxSelected.setData(
    ...
    def plot_ss_ifr_histogram(self):
        self.txtlabel_mainwin_SsPanel_plots_SsFiring.setText(
            "SS Firing: {:.1f}Hz".format(self._workingDataBase["ss_ifr_mean"][0])
        )
    ...
    def plot_cs_ifr_histogram(self):
        self.txtlabel_mainwin_CsPanel_plots_CsFiring.setText(
            "CS Firing: {:.2f}Hz".format(self._workingDataBase["cs_ifr_mean"][0])
        )
    ...
    def plot_ss_xprob(self):
        self.pltData_SsXProb.setData(
            self._workingDataBase["ss_xprob_span"] * 1000.0,
            self._workingDataBase["ss_xprob"],
            connect="finite",
        )
        self.viewBox_SsXProb.autoRange()
        self.viewBox_SsXProb.setLimits(yMin=0.0, minYRange=0.0)
        vb_range = self.viewBox_SsXProb.viewRange()
        self.viewBox_SsXProb.setYRange(0.0, vb_range[1][1])
        return 0

    def plot_cs_xprob(self):
        self.pltData_CsXProb.setData(
            self._workingDataBase["cs_xprob_span"] * 1000.0,
            self._workingDataBase["cs_xprob"],
            connect="finite",
        )
        self.viewBox_CsXProb.autoRange()
        self.viewBox_CsXProb.setLimits(yMin=0.0, minYRange=0.0)
        vb_range = self.viewBox_CsXProb.viewRange()
        self.viewBox_CsXProb.setYRange(0.0, vb_range[1][1])
        return 0
    ...
    def plot_ss_waveform(self):
        ...
        idx = np.random.choice(
            tot_sample, size=int(tot_sample / step_size), replace=False
        )

        nan_array = np.full(
            (self._workingDataBase["ss_wave"][idx, :].shape[0]), np.NaN
        ).reshape(-1, 1)
        ss_waveform = np.append(
            self._workingDataBase["ss_wave"][idx, :], nan_array, axis=1
        )
        ss_wave_span = np.append(
            self._workingDataBase["ss_wave_span"][idx, :], nan_array, axis=1
        )
        ...
        self.pltData_SsWaveSelected.setData(
            ss_wave_span_selected.ravel() * 1000.0,
            ss_waveform_selected.ravel(),
            connect="finite",
        )
        self.pltData_SsWaveTemplate.setData(
    ...
    def plot_cs_waveform(self):
        ...
        nan_array = np.full(
            (self._workingDataBase["cs_wave"][idx, :].shape[0]), np.NaN
        ).reshape(-1, 1)
        cs_waveform = np.append(
            self._workingDataBase["cs_wave"][idx, :], nan_array, axis=1
        )
        cs_wave_span = np.append(
            self._workingDataBase["cs_wave_span"][idx, :], nan_array, axis=1
        )
        ...
        self.pltData_CsWaveSelected.setData(
            cs_wave_span_selected.ravel() * 1000.0,
            cs_waveform_selected.ravel(),
            connect="finite",
        )
        self.pltData_CsWaveTemplate.setData(
    ...
    def plot_ss_pca(self):
        self.pltData_SsPca.setData(
            self._workingDataBase["ss_scatter1"], self._workingDataBase["ss_scatter2"]
        )
        if self._workingDataBase["ss_index"].sum() > 1:
            _ss_index_selected = self._workingDataBase["ss_index_selected"]
            self.pltData_SsPcaSelected.setData(
                self._workingDataBase["ss_scatter1"][_ss_index_selected,],
                self._workingDataBase["ss_scatter2"][_ss_index_selected,],
            )
        else:
            self.pltData_SsPcaSelected.setData(np.zeros((0)), np.zeros((0)))
        self.viewBox_SsPca.autoRange()
        return 0

    def plot_cs_pca(self):
        self.pltData_CsPca.setData(
            self._workingDataBase["cs_scatter1"], self._workingDataBase["cs_scatter2"]
        )
        if self._workingDataBase["cs_index"].sum() > 1:
            _cs_index_selected = self._workingDataBase["cs_index_selected"]
            self.pltData_CsPcaSelected.setData(
                self._workingDataBase["cs_scatter1"][_cs_index_selected,],
                self._workingDataBase["cs_scatter2"][_cs_index_selected,],
            )
        else:
            self.pltData_CsPcaSelected.setData(np.zeros((0)), np.zeros((0)))
        self.viewBox_CsPca.autoRange()
        return 0
    ...
    def undoRedo_reset(self):
        ...
        self._workingDataBase["ss_index_undoRedo"] = np.zeros(
            (batch_size, len_data), dtype=bool
        )
        self._workingDataBase["cs_index_slow_undoRedo"] = np.zeros(
            (batch_size, len_data), dtype=bool
        )
        self._workingDataBase["cs_index_undoRedo"] = np.zeros(
            (batch_size, len_data), dtype=bool
        )
    ...
    def undoRedo_append(self):
        ...
        self._workingDataBase["ss_index_undoRedo"] = np.vstack(
            (
                ...
                np.zeros((batch_size, len_data), dtype=bool),
            )
        )
    ...
    def undoRedo_enable(self):
        ...
        if self._workingDataBase["index_undoRedo"][0] <= 0:
            ...
            self._workingDataBase["index_undoRedo"][0]
    ...
    def undoRedo_add(self):
        if self._workingDataBase["ss_index_undoRedo"].shape[1] != len(
        ...
        self._workingDataBase["ss_index_undoRedo"][index_undoRedo, :] = deepcopy(
            self._workingDataBase["ss_index"]
        )
        self._workingDataBase["cs_index_slow_undoRedo"][index_undoRedo, :] = deepcopy(
            self._workingDataBase["cs_index_slow"]
        )
        self._workingDataBase["cs_index_undoRedo"][index_undoRedo, :] = deepcopy(
    ...
    def undoRedo_undo(self):
        ...
        index_undoRedo = self._workingDataBase["index_undoRedo"][0] - 1
        self._workingDataBase["ss_index"] = deepcopy(
            self._workingDataBase["ss_index_undoRedo"][index_undoRedo, :]
        )
        self._workingDataBase["cs_index_slow"] = deepcopy(
            self._workingDataBase["cs_index_slow_undoRedo"][index_undoRedo, :]
        )
        self._workingDataBase["cs_index"] = deepcopy(
    ...
    def connect_ScatterSelectWidget(self):
        ...
        self.ScatterSelectWidget.pushBtn_scatterSelect_cancel.clicked.connect(
            self.onScatterSelect_Cancel_Clicked
        )
        self.ScatterSelectWidget.pushBtn_scatterSelect_ok.clicked.connect(
            self.onScatterSelect_Ok_Clicked
        )
        ...
        self.proxy_MouseClicked_ScatterSelect = pg.SignalProxy(
            self.ScatterSelectWidget.plot_scatterSelect_mainPlot.scene().sigMouseClicked,
            rateLimit=60,
            slot=self.ScatterSelectWidget.scatterSelect_mouseClicked,
        )
        return 0
    ...
    def onSsPanel_selectPcaData_Clicked(self):
        ...
        if (
            ...
            doubleSpinBx_params = {}
            doubleSpinBx_params["value"] = 2.0
            doubleSpinBx_params["dec"] = 0
            doubleSpinBx_params["step"] = 1.0
            doubleSpinBx_params["max"] = 10
            doubleSpinBx_params["min"] = 2.0
            doubleSpinBx_params["okDefault"] = True
            self.input_dialog = PsortInputDialog(
                self, message=message, doubleSpinBx_params=doubleSpinBx_params
            )
    ...
    def scatterSelect_task_completed(self):
        if self._workingDataBase["popUp_mode"] == np.array(
            ...
            self._workingDataBase["ss_pca2_ROI"] = np.append(
                self.ScatterSelectWidget._workingDataBase["popUp_ROI_y"],
            ...
            self._workingDataBase["ss_index_selected"] = lib.inpolygon(
            ...
            self._workingDataBase["cs_pca2_ROI"] = np.append(
                self.ScatterSelectWidget._workingDataBase["popUp_ROI_y"],
                self.ScatterSelectWidget._workingDataBase["popUp_ROI_y"][0],
            )
            ...
            self._workingDataBase["cs_index_selected"] = lib.inpolygon(
            ...
            self._workingDataBase["ss_wave_span_ROI"] = np.zeros((0), dtype=np.float32)
            self._workingDataBase["ss_wave_ROI"] = np.zeros((0), dtype=np.float32)
            self._workingDataBase["ss_index_selected"] = deepcopy(
                self.ScatterSelectWidget._workingDataBase["ss_index_selected"]
            )
            self.plot_ss_pca()
            self.plot_ss_waveform()
            self.plot_rawSignal(just_update_selected=True)
            ...
            self._workingDataBase["cs_wave_span_ROI"] = np.zeros((0), dtype=np.float32)
            self._workingDataBase["cs_wave_ROI"] = np.zeros((0), dtype=np.float32)
            self._workingDataBase["cs_index_selected"] = deepcopy(
                self.ScatterSelectWidget._workingDataBase["cs_index_selected"]
            )
            self.plot_cs_pca()
            self.plot_cs_waveform()
            self.plot_rawSignal(just_update_selected=True)
    ...
    def connect_WaveDissectWidget(self):
        ...
        self.WaveDissectWidget.pushBtn_rawPlot_popup_cancel.clicked.connect(
            self.onWaveDissect_Cancel_Clicked
        )
        self.WaveDissectWidget.pushBtn_rawPlot_popup_ok.clicked.connect(
            self.onWaveDissect_Ok_Clicked
        )

        self.proxy_MouseMoved_WaveDissectRaw = pg.SignalProxy(
            self.WaveDissectWidget.plot_popup_rawPlot.scene().sigMouseMoved,
            rateLimit=60,
        ...
        self.proxy_MouseClicked_WaveDissectRaw = pg.SignalProxy(
            ...
            rateLimit=60,
            slot=self.WaveDissectWidget.popUpPlot_mouseClicked_raw,
        )  # J
        self.proxy_MouseClicked_WaveDissectSS = pg.SignalProxy(
            self.WaveDissectWidget.plot_popup_sidePlot1.scene().sigMouseClicked,
            rateLimit=60,
            slot=self.WaveDissectWidget.popUpPlot_mouseClicked_SS,
        )  # J
        self.proxy_MouseClicked_WaveDissectCS = pg.SignalProxy(
            self.WaveDissectWidget.plot_popup_sidePlot2.scene().sigMouseClicked,
            rateLimit=60,
            slot=self.WaveDissectWidget.popUpPlot_mouseClicked_CS,
        )  # J
        return 0
    ...
    def onWaveDissect_Ok_Clicked(self):
        ...
        if (
            np.sum(
                np.logical_xor(
                    self._workingDataBase["ss_index"],
                    self.WaveDissectWidget._workingDataBase["ss_index"],
                )
            )
            > 0
        ):
        ...
        if (
            np.sum(
                np.logical_xor(
                    self._workingDataBase["cs_index"],
                    self.WaveDissectWidget._workingDataBase["cs_index"],
                )
            )
            > 0
        ):
            ...
            self._workingDataBase["cs_index_slow"] = deepcopy(
                self.WaveDissectWidget._workingDataBase["cs_index_slow"]
            )
            flag_update = True
        self._workingDataBase["ss_index_selected"] = deepcopy(
            self.WaveDissectWidget._workingDataBase["ss_index_selected"]
        )
        self._workingDataBase["cs_index_selected"] = deepcopy(
            self.WaveDissectWidget._workingDataBase["cs_index_selected"]
        )
        self._workingDataBase["flag_index_detection"][0] = False
        self.refresh_workingDataBase()
        if flag_update:
    ...
    def onPushBtn_waveDissect_Clicked(self, spike_of_interest):
        ...
        self.WaveDissectWidget.pushBtn_waveDissect_Clicked(
            y_zoom_level, spike_of_interest
        )
    ...
    def connect_SlotBoundaryWidget(self):
        ...
        self.SlotBoundaryWidget.pushBtn_slotBoundary_cancel.clicked.connect(
            self.onSlotBoundary_Cancel_Clicked
        )
        self.SlotBoundaryWidget.pushBtn_slotBoundary_ok.clicked.connect(
            self.onSlotBoundary_Ok_Clicked
        )
        self.proxy_MouseMoved_SlotBoundary = pg.SignalProxy(
            self.SlotBoundaryWidget.plot_slotBoundary_mainPlot.scene().sigMouseMoved,
            rateLimit=60,
            slot=self.SlotBoundaryWidget.slotBoundary_mouseMoved,
        )
        self.proxy_MouseClicked_SlotBoundary = pg.SignalProxy(
            self.SlotBoundaryWidget.plot_slotBoundary_mainPlot.scene().sigMouseClicked,
            rateLimit=60,
            slot=self.SlotBoundaryWidget.slotBoundary_mouseClicked,
        )
        return 0
    ...
    def slotBoundary_showWidget(self, showSlotBoundary=False, restart_mode="hard"):
        ...
        if showSlotBoundary:
            psort_grandDataBase = self.psortDataBase.get_grandDataBase_Pointer()
            self.SlotBoundaryWidget._workingDataBase["ch_data"] = psort_grandDataBase[
                -1
            ]["ch_data"]
            self.SlotBoundaryWidget._workingDataBase["sample_rate"][
                0
            ] = psort_grandDataBase[-1]["sample_rate"][0]
            self.SlotBoundaryWidget._workingDataBase["index_slot_edges"] = deepcopy(
                psort_grandDataBase[-1]["index_slot_edges"]
            )
    ...
    def connect_WaveClustWidget(self):
        ...
        self.WaveClustWidget.pushBtn_scatterPlot_popup_cancel.clicked.connect(
            self.onWaveClust_Cancel_Clicked
        )
        self.WaveClustWidget.pushBtn_scatterPlot_popup_ok.clicked.connect(
            self.onWaveClust_Ok_Clicked
        )

        self.proxy_MouseMoved_WaveClustScatter = pg.SignalProxy(
            self.WaveClustWidget.plot_popup_scatter.scene().sigMouseMoved,
            rateLimit=60,
            slot=self.WaveClustWidget.popUpPlot_mouseMoved_scatter,
        )
        self.proxy_MouseClicked_WaveClustScatter = pg.SignalProxy(
            self.WaveClustWidget.plot_popup_scatter.scene().sigMouseClicked,
            rateLimit=60,
            slot=self.WaveClustWidget.popUpPlot_mouseClicked_scatter,
        )
        self.proxy_MouseClicked_WaveClustWaveform = pg.SignalProxy(
            self.WaveClustWidget.plot_popup_waveform.scene().sigMouseClicked,
            rateLimit=60,
            slot=self.WaveClustWidget.popUpPlot_mouseClicked_waveform,
        )
        return 0
    ...
    def onWaveClust_Ok_Clicked(self):
        ...
        if (
            np.sum(
                np.logical_xor(
                    self._workingDataBase["ss_index"],
                    self.WaveClustWidget._workingDataBase["ss_index"],
                )
            )
            > 0
        ):
        ...
        if (
            np.sum(
                np.logical_xor(
                    self._workingDataBase["cs_index"],
                    self.WaveClustWidget._workingDataBase["cs_index"],
                )
            )
            > 0
        ):
            ...
            self._workingDataBase["cs_index_slow"] = deepcopy(
                self.WaveClustWidget._workingDataBase["cs_index_slow"]
            )
            flag_update = True
        self._workingDataBase["ss_index_selected"] = deepcopy(
            self.WaveClustWidget._workingDataBase["ss_index_selected"]
        )
        self._workingDataBase["cs_index_selected"] = deepcopy(
            self.WaveClustWidget._workingDataBase["cs_index_selected"]
        )
    ...
    def onSsPanel_waveClust_Clicked(self):
        ...
        if not (self.WaveClustWidget._localDataBase["current_slot_num"] == slot_num):
            self.WaveClustWidget._localDataBase["ss_index_labels"] = np.zeros_like(
                self._workingDataBase["ss_index"], dtype=np.int32
            )
            self.WaveClustWidget._localDataBase["ss_index_labels"][
                self._workingDataBase["ss_index"] == False
            ] = lib.nanLabel
            self.WaveClustWidget._localDataBase["cs_index_labels"] = np.zeros_like(
                self._workingDataBase["cs_index"], dtype=np.int32
            )
            self.WaveClustWidget._localDataBase["cs_index_labels"][
                self._workingDataBase["cs_index"] == False
            ] = lib.nanLabel
    ...
    def update_SSPcaNum_comboBx(self):
        if self._workingDataBase["ss_index"].sum() > 1:
            ...
            self.comboBx_mainwin_SsPanel_plots_SsPcaPlot_PcaNum1.addItems(
                self._workingDataBase["ss_scatter_list"]
            )
            self.comboBx_mainwin_SsPanel_plots_SsPcaPlot_PcaNum2.addItems(
                self._workingDataBase["ss_scatter_list"]
            )
            if not (self._workingDataBase["umap_enable"][0]):
                self.comboBx_mainwin_SsPanel_plots_SsPcaPlot_PcaNum1.model().item(
                    3
                ).setEnabled(False)
                self.comboBx_mainwin_SsPanel_plots_SsPcaPlot_PcaNum1.model().item(
                    4
                ).setEnabled(False)
                self.comboBx_mainwin_SsPanel_plots_SsPcaPlot_PcaNum2.model().item(
                    3
                ).setEnabled(False)
                self.comboBx_mainwin_SsPanel_plots_SsPcaPlot_PcaNum2.model().item(
                    4
    ...
    def update_CSPcaNum_comboBx(self):
        if self._workingDataBase["cs_index"].sum() > 1:
            ...
            self.comboBx_mainwin_CsPanel_plots_CsPcaPlot_PcaNum1.addItems(
                self._workingDataBase["cs_scatter_list"]
            )
            self.comboBx_mainwin_CsPanel_plots_CsPcaPlot_PcaNum2.addItems(
                self._workingDataBase["cs_scatter_list"]
            )
            if not (self._workingDataBase["umap_enable"][0]):
                self.comboBx_mainwin_CsPanel_plots_CsPcaPlot_PcaNum1.model().item(
                    3
                ).setEnabled(False)
                self.comboBx_mainwin_CsPanel_plots_CsPcaPlot_PcaNum1.model().item(
                    4
                ).setEnabled(False)
                self.comboBx_mainwin_CsPanel_plots_CsPcaPlot_PcaNum2.model().item(
                    3
                ).setEnabled(False)
                self.comboBx_mainwin_CsPanel_plots_CsPcaPlot_PcaNum2.model().item(
                    4
    ...
    def transfer_data_from_psortDataBase_to_guiSignals(self):
        ...
        self._workingDataBase["ch_data"] = psortDataBase_topLevel["ch_data"][
            index_start_on_ch_data:index_end_on_ch_data
        ]
        self._workingDataBase["ch_time"] = psortDataBase_topLevel["ch_time"][
            index_start_on_ch_data:index_end_on_ch_data
        ]
        self._workingDataBase["ss_index"] = psortDataBase_topLevel["ss_index"][
            index_start_on_ch_data:index_end_on_ch_data
        ]
        self._workingDataBase["cs_index"] = psortDataBase_topLevel["cs_index"][
            index_start_on_ch_data:index_end_on_ch_data
        ]
        self._workingDataBase["cs_index_slow"] = psortDataBase_topLevel[
            "cs_index_slow"
        ][index_start_on_ch_data:index_end_on_ch_data]
        self._workingDataBase["sample_rate"][0] = psortDataBase_topLevel["sample_rate"][
            0
        ]
        if psortDataBase_topLevel["isLfpSideloaded"][0]:
            self._workingDataBase["ch_lfp"] = psortDataBase_topLevel["ch_lfp"][
                index_start_on_ch_data:index_end_on_ch_data
            ]
        self._workingDataBase["isLfpSideloaded"][0] = psortDataBase_topLevel[
            "isLfpSideloaded"
        ][0]
    ...
    def update_guiWidgets_from_guiDataBase(self):
        ...
        # ss_pca_bound
        self.infLine_SsWave_minPca.setValue(
            self._workingDataBase["ss_pca_bound_min"][0] * 1000.0
        )
        self.infLine_SsWave_maxPca.setValue(
            self._workingDataBase["ss_pca_bound_max"][0] * 1000.0
        )
        # cs_pca_bound
        self.infLine_CsWave_minPca.setValue(
            self._workingDataBase["cs_pca_bound_min"][0] * 1000.0
        )
        self.infLine_CsWave_maxPca.setValue(
            self._workingDataBase["cs_pca_bound_max"][0] * 1000.0
        )
        # ss_pca_index
        self.comboBx_mainwin_SsPanel_plots_SsPcaPlot_PcaNum1.setCurrentIndex(
            self._workingDataBase["ss_pca1_index"][0]
